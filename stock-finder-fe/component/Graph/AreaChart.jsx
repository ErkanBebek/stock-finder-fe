...
const prepareData = (data) => {
    ...
    const preparedData = sortedData.map(item => ({
        ...
        value: item.close // Area chart için close değerini kullanıyoruz
    }));
...
const CandleChart = ({ locale, symbol }) => {
    ...
    const colors = {
        ...
        areaTopColor: 'rgba(41, 98, 255, 0.5)', // Alanın üst rengi
        areaBottomColor: 'rgba(41, 98, 255, 0.0)', // Alanın alt rengi
    };
    ...
    }, [preparedData, colors.backgroundColor, colors.textColor, colors.lineColor, colors.areaTopColor, colors.areaBottomColor]);
